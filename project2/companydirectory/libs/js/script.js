...
function populateLocationSelection(locations, selectElement) {
  ...
  // Assuming 'locations' is an array of location objects with 'id' and 'name' properties
...
// Event listener for the form submission of the "addDepartmentForm"
$("#addDepartmentForm").submit(function (e) {
  e.preventDefault(); // Prevent the default form submission

  

  // After successfully adding the department, you may want to close the modal
  ...
  var Department = parseInt($("#addPersonnelDepartment").val()); // You'll need the department ID or a corresponding identifier
    ...
    $.ajax({
      ...
      data: {
        ...
        jobTitle: JobTitle,
        email: EmailAddress,
        departmentID:Department // Assuming this should correspond to the selected department
        // Add other updated data fields if needed
      },
      success: function (result) {
...
//       name: $("#addLocationName").val().toString(),
//     },
//     success: function (result) {
...
$(document).on('click', '#confirmLocationBtn', function (e) {
  e.preventDefault(); // Prevent the form submission
